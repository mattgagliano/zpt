...
public class TESTSITES_AutomationModelLookupCallTest {

	protected TESTSITES_AutomationModelLookupCall createLookupCall() {
		return new TESTSITES_AutomationModelLookupCall();
	}

	@Test
	public void testLookupByAll() {
		TESTSITES_AutomationModelLookupCall call = createLookupCall();
